...
model_saved_file_name = 'darima-master/result/darima_model_' + series_name + '_' + time.strftime("%Y-%m-%d-%H:%M:%S", time.localtime()) + '.pkl'
coef_saved_file_name = 'darima-master/result/darima_coef_' + series_name + '_' + time.strftime("%Y-%m-%d-%H:%M:%S", time.localtime()) + '.csv'
...
# max_p = 6; max_q = 6; max_P = 2; max_Q = 2; max_order = 7
# max_p = 6; max_q = 6; max_P = 3; max_Q = 3; max_order = 10
# max_p = 8; max_q = 8; max_P = 4; max_Q = 4; max_order = 10
max_d = 2; max_D = 1
...
#-----------------------------------------------------------------------------------------
file_train_path = ['darima-master/data/' + series_name + '_train.csv'] # HDFS file
file_test_path = ['darima-master/data/' + series_name + '_test.csv'] # HDFS file
